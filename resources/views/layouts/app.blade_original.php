...
<meta name="keyword" content="Bootstrap,agronomia,Template,Open,Source,jQuery,CSS,HTML,Dashboard">
...
<body class="app header-fixed sidebar-fixed aside-menu-fixed sidebar-lg-show">
	<header class="app-header navbar">
		...
		<a class="navbar-brand" href="/"> 
			<img class="navbar-brand-full" src="{{ asset('img/logos/teinco-min.png') }}" width="89" height="35" title="Tecnolog&iacute;a, Informaci&oacute;n y Comunicaci&oacute;n">
			<img class="navbar-brand-minimized" src="{{ asset('img/logos/teinco-cubo.png') }}" width="30" height="30" title="Tecnolog&iacute;a, Informaci&oacute;n y Comunicaci&oacute;n">
		</a>
		...
		<ul class="nav navbar-nav ml-auto">
			...
			<li class="nav-item dropdown">
				...
				<div class="dropdown-menu dropdown-menu-right">
					...
					<a class="dropdown-item" href="#"> <i class="fa fa-envelope-o"></i>
					...
					<a class="dropdown-item" href="#"> <i class="fa fa-file"></i>
	...
	<div class="app-body">
		<div class="sidebar">
			<nav class="sidebar-nav">
				<ul class="nav">
					...
					<li class="nav-title">Modulo - Titulo #1</li>
					<li class="nav-item">
					...
					<li class="nav-title">Modulo - Titulo #2</li>
					<li class="nav-item nav-dropdown">
						...
						<ul class="nav-dropdown-items">
							...
							<li class="nav-item"><a class="nav-link" href="base-progress.html"> 
								<i class="nav-icon icon-puzzle"></i> Progress
								</a>
							</li>
							<li class="nav-item"><a class="nav-link" href="base-scrollspy.html"> 
							...
							<li class="nav-item">
								<a class="nav-link" href="base-tabs.html"> 
									<iclass="nav-icon icon-puzzle"></i> Tabs
								</a>
							</li>
							<li class="nav-item">
					...
					<li class="nav-item nav-dropdown">
						...
						<ul class="nav-dropdown-items">
							<li class="nav-item">
								<a class="nav-link" href="buttons-buttons.html"> <i class="nav-icon icon-cursor"></i>
									Buttons
								</a>
							</li>
							<li class="nav-item">
						...
						<ul class="nav-dropdown-items">
							<li class="nav-item">
								<a class="nav-link" href="icons-coreui-icons.html"> 
									...
									CoreUI Icons <span class="badge badge-success">NEW</span>
								</a> 
							...
							<li class="nav-item">
								<a class="nav-link" href="icons-font-awesome.html"> 
									<i class="nav-icon icon-star"></i>
									Font Awesome <span class="badge badge-secondary">4.7</span>
								</a>
							</li>
							<li class="nav-item">
		...
		<main class="main"> 
		<ol class="breadcrumb">
			<li class="breadcrumb-item">TEINCO</li>
							...
							<div class="col-sm-7 d-none d-md-block">
								...
								<div class="btn-group btn-group-toggle float-right mr-3"
									...
									<label class="btn btn-outline-secondary"> <input type="radio"
										name="options" id="option1" autocomplete="off"> Day
										...
										<div class="row">
											...
											<div class="col-sm-6">
												<div class="callout callout-danger">
													<small class="text-muted">Recuring Clients</small> <br> <strong
														class="h4">22,643</strong>
													<div class="chart-wrapper">
									...
									<tbody>
										<tr>
											...
											<td class="text-center"><i
												class="flag-icon flag-icon-us h4 mb-0" title="us" id="us"></i>
											</td>
											<td>
												<div class="clearfix">
										...
										<tr>
											...
											<td class="text-center"><i
												class="flag-icon flag-icon-br h4 mb-0" title="br" id="br"></i>
											</td>
											<td>
												<div class="clearfix">
													<div class="float-left">
										...
										<tr>
											...
											<td class="text-center"><i
												class="flag-icon flag-icon-in h4 mb-0" title="in" id="in"></i>
											</td>
											<td>
												<div class="clearfix">
													<div class="float-left">
										...
										<tr>
											...
											<td class="text-center"><i
												class="flag-icon flag-icon-fr h4 mb-0" title="fr" id="fr"></i>
											</td>
											<td>
												<div class="clearfix">
													<div class="float-left">
										...
										<tr>
											...
											<td class="text-center"><i
												class="flag-icon flag-icon-es h4 mb-0" title="es" id="es"></i>
											</td>
											<td>
												<div class="clearfix">
													<div class="float-left">
										...
										<tr>
											...
											<td class="text-center"><i
												class="flag-icon flag-icon-pl h4 mb-0" title="pl" id="pl"></i>
											</td>
											<td>
												<div class="clearfix">
													<div class="float-left">
		...
		<aside class="aside-menu">
			<ul class="nav nav-tabs" role="tablist">
				<li class="nav-item"><a class="nav-link active" data-toggle="tab"
					href="#timeline" role="tab"> <i class="icon-list"></i>
				</a></li>
			...
			<div class="tab-content">
				...
				<div class="tab-pane p-3" id="messages" role="tabpanel">
					<div class="message">
						...
						<div class="text-truncate font-weight-bold">Lorem ipsum dolor sit
							amet</div>
